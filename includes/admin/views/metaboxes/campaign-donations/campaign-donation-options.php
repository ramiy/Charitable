...
$custom_donations_enabled = get_post_meta( $post->ID, 'campaign_custom_donations_enabled', true );
$suggested_donations = (array) get_post_meta( $post->ID, 'campaign_suggested_donations', true );
?>
<section class="charitable-metabox-section">
	...
	<p class="charitable-metabox-field">
		...
		<input type="checkbox" id="campaign_custom_donations_enabled" name="campaign_custom_donations_enabled" <?php checked($custom_donations_enabled) ?> />
	</p>
	<p class="charitable-metabox-field">
		...
		<?php foreach ( $suggested_donations as $donation ) : ?>
			<input type="text" id="campaign_suggested_donations" name="campaign_suggested_donations[]" value="<?php echo $donation ?>" />
		<?php endforeach ?>
