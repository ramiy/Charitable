...
<a href="<?php echo esc_url( add_query_arg( array( "post_type" => Charitable::DONATION_POST_TYPE ), admin_url( "edit.php" ) ) );?>" class="charitable-donations-clear button dashicons-before dashicons-clear"><?php _e( 'Clear', 'charitable' ) ?></a>
<?php endif; ?>
