...
class Test_Charitable extends WP_UnitTestCase {
	...
	function test_load_dependencies() {
        ...
        $this->assertFileExists( $this->charitable->get_path( 'includes' ) . 'class-charitable-donation-amount-form.php' );
        ...
        $this->assertFileExists( $this->charitable->get_path( 'includes' ) . 'class-charitable-emails.php' );        
        $this->assertFileExists( $this->charitable->get_path( 'includes' ) . 'class-charitable-gateways.php' );
	...
	function test_attach_hooks_and_filters() {
		...
		$this->assertEquals( 3, has_action('charitable_start', array( 'Charitable_Gateways', 'charitable_start' ) ) );
        $this->assertEquals( 3, has_action('charitable_start', array( 'Charitable_Emails', 'charitable_start' ) ) );
        $this->assertEquals( 3, has_action('charitable_start', array( 'Charitable_Request', 'charitable_start' ) ) );
	}
